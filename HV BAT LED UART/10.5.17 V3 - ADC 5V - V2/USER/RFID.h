...
// DINH NGHIA CAC CHAN //
#define SAD             GPIOC_ODR.PIN7
#define SCK             GPIOC_ODR.PIN6
#define MOSI            GPIOC_ODR.PIN5
#define RST_RFID        GPIOA_ODR.PIN3
#define MISO            GPIOC_IDR.PIN4            //input
#define POWER_RFID      GPIOB_ODR.PIN5
...
extern unsigned char AserNum[5]; 
