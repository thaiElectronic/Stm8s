...
#define Port_CE	        GPIOD	
#define Port_CSN	GPIOD
#define SetCE	GPIO_WriteHigh(Port_CE, CE)
#define ClrCE	GPIO_WriteLow(Port_CE, CE)

#define SetCSN	GPIO_WriteHigh(Port_CSN, CSN)
#define ClrCSN	GPIO_WriteLow(Port_CSN, CSN)
